                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge badge-soft-info fs-12">Fashion</span></li>
                                                    </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge badge-soft-primary fs-12">Product</span></li>
                                                    </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge badge-soft-danger fs-12">Design</span></li>
                                                    </ul>
