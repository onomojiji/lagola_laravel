                ...
                <div class="card-header border-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <button class="btn btn-secondary" onClick="deleteMultiple()"><i
                        ...
                        <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td class="id"><a href="{{URL::asset('/apps-tasks-details')}}"
                                            class="fw-medium link-primary">#VLZ501</a></td>
                                    <td class="project_name"><a href="{{URL::asset('/apps-projects-overview')}}"
