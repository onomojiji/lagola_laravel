                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 form-group">
                                ...
                                <input value="{{ $product->name }}" id="name" type="text" name="name" class="form-control" placeholder="{{__("Tapez le nom du produit")}}" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-12 form-group">
                                ...
                                <div class="input-group">
                                    <input value="{{ $product->purchase_price }}" type="number" class="form-control" placeholder="{{__("Tapez le prix d'achat du produit")}}" name="purchase_price" min="0" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 form-group">
                                ...
                                <div class="input-group">
                                    <input value="{{ $product->price }}" type="number" class="form-control" placeholder="{{__("Tapez le prix de vente du produit")}}" name="price" min="0" required>
                                    <span class="input-group-text">Fcfa</span>
                                </div>
                            </div>
                        </div>
